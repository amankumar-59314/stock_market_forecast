...
st.title(app_name)
st.subheader("This app is created to Aman choudhary 😁")
st.image("https://th.bing.com/th/id/OIP.tVTO8Flx-MubmG5l_sKP0wHaEK?w=333&h=187&c=7&r=0&o=5&dpr=1.3&pid=1.7")
